...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'model',
      content: "Hi I'm AiPEX! I'm your APEC Schools Marikina Heights assistant. How can I help you today?"
    }
  ]);
      ...
      <div className="container max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="flex flex-col h-[70vh]">
          ...
          <div className="flex-1 p-4 overflow-y-auto">
            {messages.map((msg, index) => (
              <div
                ...
                className={`p-3 mb-4 max-w-[75%] ${
                  msg.role === 'user'
                    ? 'ml-auto bg-blue-400 rounded-t-lg rounded-l-lg'
                    : 'bg-orange-400 rounded-t-lg rounded-r-lg'
                }`}
              >
                <ReactMarkdown
                  components={{
            ...
            {isLoading && (
              <div className="bg-orange-100 p-3 mb-4 max-w-[75%] rounded-t-lg rounded-r-lg inline-flex">
          ...
          <div className="border-t p-4">
            <form onSubmit={handleSubmit} className="flex">
              <input
                ...
                className="flex-grow border border-orange-300 rounded-l-lg p-3 focus:outline-none focus:ring-2 focus:ring-orange-400 text-orange placeholder:text-orange-400"
                disabled={isLoading}
              />
              <button
                type="submit"
